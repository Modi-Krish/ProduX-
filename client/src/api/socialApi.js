...
export const sendMessage = (receiverId, text, fileData) => API.post('/social/messages', { receiverId, text, ...fileData });
export const fetchMessages = (userId) => API.get(`/social/messages/${userId}`);
export const fetchConversations = () => API.get('/social/conversations');
export const markMessagesSeen = (senderId) => API.post('/social/messages/seen', { senderId });
...
export const sendGroupMessage = (groupId, text, fileData) => API.post(`/social/groups/${groupId}/messages`, { text, ...fileData });
...
export const triggerPushNotification = (payload) => API.post('/social/push-notify', payload);
