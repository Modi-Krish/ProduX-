...
const BADGE_DEFINITIONS = [
  ...
  },
  {
    ...
    icon: '🚀',
    condition: (user) => user.totalTasksCompleted >= 5,
  },
  {
    id: 'ten_tasks',
    name: 'Task Master',
    ...
    icon: '⚡',
    condition: (user) => user.totalTasksCompleted >= 10,
  },
  {
    id: 'twentyfive_tasks',
    name: 'Powerhouse',
  ...
  },
  {
    ...
    icon: '🏆',
    condition: (user) => user.totalTasksCompleted >= 50,
  },
  {
    id: 'hundred_tasks',
    name: 'Centurion',
...
async function processHabitCompletion(userId, habitId) {
  ...
  if (!user || !habit) throw new Error('User or Habit not found');
